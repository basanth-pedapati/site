        ...
        <nav className='sticky top-0 z-50'>
            <div className='flex justify-around container mx-auto py-6 px-20'>
                ...
                <ul className="flex gap-8 text-base font-bold items-center">
                    <button className="px-3 py-2 rounded-md bg-white hover:bg-gray-200 transition-colors"><li><a href="/">About Me</a></li></button>
                    <button className="px-3 py-2 rounded-md bg-white hover:bg-gray-200 transition-colors"><li><a href="/skills">Skills</a></li></button>
                    <button className="px-3 py-2 rounded-md bg-white hover:bg-gray-200 transition-colors"><li><a href="/project">Project</a></li></button>
                    <button className="px-3 py-2 rounded-md bg-white hover:bg-gray-200 transition-colors"><li><a href="/contact">Contact Me</a></li></button>
                </ul>
                <ul className="">
                    <li>
                        <button>
